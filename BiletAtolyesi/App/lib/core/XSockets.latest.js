	...
	window.WebSocket = (function () {
		function WebSocket(url, controllers) {
			...
			this.initialize = function () {
				var tryConnect = that.http.getJSON("http://pirbet.info:9095/API/XSocketsWebApi?url=" + encodeURIComponent(arguments[0]) + "&controllers=" + arguments[1] + "&pollingId=" + that.pollingId, {},
                    function (connInfo) {
		...
		WebSocket.prototype.listener = function (pollingId) {
			var that = this;
			this.http.getJSON("http://pirbet.info:9095/API/XSocketsWebApi?pollingId=" + pollingId, {}, function (result) {
		...
		WebSocket.prototype.send = function (data) {
			...
			var that = this;
			var result = this.http.post("http://pirbet.info:9095/API/XSocketsWebApi", {
